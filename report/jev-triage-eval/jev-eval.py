...
Q = {
  ...
  "kind": {"type": "choice",
    "instructions": "What kind of letter is `letter`?",
    "criteria": {"question": "asks the recipient something and waits for the answer",
                 "request": "asks the recipient to perform an action or task",
                 "report": "answers an earlier question or reports results, findings or completed work",
                 "info": "shares information or a notice; no reply or action expected",
...
for f in sorted(os.listdir(S)):
    ...
    out = S + '/' + f.replace('.letter', '.jev.json')
