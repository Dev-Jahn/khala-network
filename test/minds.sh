...
property_m9() {
    ...
    [ "$(KHALA_HOME=$home "$KHALA" version)" = 'khala 0.8.2' ] || die "brain version is not 0.8.2"
    grep -q '"version": "0.8.2"' "$ROOT/plugin/.claude-plugin/plugin.json" ||
        die "plugin version is not 0.8.2"
