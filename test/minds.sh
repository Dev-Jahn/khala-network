...
property_m9() {
    ...
    [ "$(KHALA_HOME=$home "$KHALA" version)" = 'khala 0.7.0' ] || die "brain version is not 0.7.0"
    grep -q '"version": "0.7.0"' "$ROOT/plugin/.claude-plugin/plugin.json" ||
        die "plugin version is not 0.7.0"
